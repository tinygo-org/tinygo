...
// Generated by gen-device.py from ATmega3290P.atdf, see http://packs.download.atmel.com/
...
const (
	...
	LCDCCR_LCDDC  = 0xe0 // LCD Display Configurations
	LCDCCR_LCDMDT = 0x10 // LCD Maximum Drive Time
	LCDCCR_LCDCC  = 0xf  // LCD Contrast Control
	...
	LCDCRB_LCDPM  = 0xf  // LCD Port Masks
...
const (
	...
	PCMSK3_PCINT = 0x7f // Pin Change Mask

	// PCMSK2: Pin Change Mask Register 2
	PCMSK2_PCINT = 0xff // Pin Change Mask

	// PCMSK1: Pin Change Mask Register 1
	PCMSK1_PCINT = 0xff // Pin Change Mask

	// PCMSK0: Pin Change Mask Register 0
	PCMSK0_PCINT = 0xff // Pin Change Mask
)
