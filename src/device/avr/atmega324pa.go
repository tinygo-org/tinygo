...
// Generated by gen-device.py from ATmega324PA.atdf, see http://packs.download.atmel.com/
...
const (
	...
	OCR2A_OCR2A = 0xff // Timer/Counter0 Output Compare A bits
...
const (
	...
	OCR1B_OCR1B = 0xff // Timer/Counter1 Output Compare B bits
...
const (
	...
	SPDR0_SPDR0 = 0xff // SPI Data bits
