...
const (
	...
	TRX_CTRL_1_Res            = 0x1f // Reserved

	// PHY_TX_PWR: Transceiver Transmit Power Control Register
	PHY_TX_PWR_PA_BUF_LT = 0xc0 // Power Amplifier Buffer Lead Time
	PHY_TX_PWR_PA_LT     = 0x30 // Power Amplifier Lead Time
