...
//go:build linux && !baremetal && !wasi && !nintendoswitch
// +build linux,!baremetal,!wasi,!nintendoswitch
...
// TODO: is there a better way to hook this in?
func init() {
	sysargs(main_argc, main_argv)
}
