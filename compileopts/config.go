...
// extension and the configured binary format in the target YAML file.
...
// particular configuration. It may either be all configured in the target YAML
...
// WasmAbi returns the WASM ABI which is specified in the target YAML file, and
