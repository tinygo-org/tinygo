...
func (c *Compiler) parseCall(frame *Frame, instr *ssa.CallCommon) (llvm.Value, error) {
	...
	if fn := instr.StaticCallee(); fn != nil {
		...
		switch {
		case name == "device/arm.ReadRegister" || name == "device/riscv.ReadRegister" || name == "device/aarch64.ReadRegister":
			return c.emitReadRegister(name, instr.Args)
		case name == "device/arm.Asm" || name == "device/avr.Asm" || name == "device/riscv.Asm" || name == "device/aarch64.Asm":
			return c.emitAsm(instr.Args)
		case name == "device/arm.AsmFull" || name == "device/avr.AsmFull" || name == "device/riscv.AsmFull" || name == "device/aarch64.AsmFull":
